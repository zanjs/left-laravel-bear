...
@section('content')
    ...
    <main class="page-content section-75 section-md-top-90 section-md-bottom-103">
            ...
            <div class="shell">
                <div class="range range-xs-center">
                    <div class="cell-sm-10 cell-md-12">
                        ...
                        <div class="offset-top-30 offset-sm-top-50"><img src="/anl/images/pages/insperation-single-01-1170x570.jpg" width="1170" height="570" alt="" class="img-responsive center-block"></div>
                        <div class="range range-xs-center offset-top-35 text-left">
                            <div class="cell-md-6">
                                <p class="text-spacing-0">Imagine the ultimate paradise; you're likely to find it in the South Pacific. Reachable from Australia and New Zealand, the South Pacific includes popular islands like Fiji, Bora Bora, Tahiti and Samoa as well as more remote stops that are diverse in culture, history and languages.</p>
                            </div>
                            <div class="cell-md-6">
                                <p class="text-spacing-0">On a South Pacific yacht charter, you can enjoy relaxed beaches and some of the world's best water sports. your journey with Yachtec crew will take you to the east of Australia from Brisbane to the enchanting islands that dot the South Pacific. Learn more about this yacht charter destination below.</p>
                            </div>
                        </div>
                ...
                <div class="range range-xs-center list-index-lg offset-md-top-25">
                    <div class="cell-sm-10 cell-md-4">
                        ...
                        <div class="offset-top-20 offset-md-top-30"><img src="/anl/images/pages/insperation-single-02-370x287.jpg" width="370" height="87" alt="" class="img-responsive center-block"></div>
                        <div class="offset-top-25 offset-md-top-40">
                            <p class="text-extra-small text-spacing-0">While still an unfrequented area for yacht charter, Australia and the surrounding waters of South Pacific offer incredible sailing, diving and exploration for those that venture there. The Whitsundays offer excellent sailing and the Great Barrier Reef is renowned worldwide for its diving.</p>
                        </div>
                        <div class="offset-top-20">
                    ...
                    <div class="cell-sm-10 cell-md-4 offset-top-64 offset-md-top-0">
                        <div class="list-index-counter h2 text-silver-chalice text-spacing-inverse-75"></div>
                        <div class="offset-top-20">
                            <h5 class="line-height-36 text-spacing-25">City life or <br class="veil reveal-lg-inline-block"> wild landscapes.</h5>
                        </div>
                        <div class="offset-top-20 offset-md-top-30"><img src="/anl/images/pages/insperation-single-03-370x287.jpg" width="370" height="87" alt="" class="img-responsive center-block"></div>
                        <div class="offset-top-25 offset-md-top-40">
