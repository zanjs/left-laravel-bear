                ...
                <div class="offset-top-55">
                    ...
                    <div class="range range-xs-center offset-top-40">
                        <div class="cell-sm-6 cell-md-4">
                            ...
                            <div class="btn-both-lines btn-both-lines-gray-lighter offset-top-15 offset-md-top-35"><a href="{{URL::route('new', 1)}}" class="btn-link text-spacing-inverce-25 text-turquoise">read more</a></div>
                        </div>
