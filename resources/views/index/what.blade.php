<section class="context-dark">
    ...
    <div data-on="false" data-md-on="true" class="rd-parallax">
        <?php
            $categoryImage = 'anl/images/backgrounds/background-09-1920x900.jpg';
            $imageT = $categoryTwo->image;
            if($imageT){
                $categoryImage = 'storage/'.$imageT;
            }
        ?>
        <div data-speed="0.25" data-type="media"
             data-url="{{asset($categoryImage)}}"
            ...
            <div class="shell section-75 section-md-top-103 section-md-bottom-110">
                <div class="range range-xs-center">
                    <div class="cell-sm-10 cell-lg-8">
                        <h2 class="text-spacing-inverse-25 text-capitalize">
                            {{$categoryTwo->name}}
                        </h2>
                        <div class="offset-top-35">
                            ...
                            <div data-items="1"
                                 ...
                                 class="owl-carousel owl-nav-absolute owl-nav-primary owl-nav-primary-type-2">
                                @foreach($whatNews as $new)
                                <div class="owl-item">
                                    <!-- Blockquote-->
                                    <blockquote class="quote">
                                        <span style="color: rgba(255,255,255,0.3);" class="icon material-icons-ico material-icons-format_quote"></span>
                                        <div class="offset-top-15">
                                            <p class="text-spacing-0">
                                                {{$new->description}}
                                            </p>
                                            <div class="offset-top-20">
                                                <cite class="p font-accent text-bold text-spacing-inverce-25">
                                                    <a href="{{URL::route('new',$new->id)}}">
                                                        {{$new->title}}
                                                    </a>
                                                </cite>
                                            </div>
                        ...
                        <div class="btn-both-lines offset-top-20">
                            <a href="{{URL::route('news',$categoryTwo->id)}}" style="min-width:240px;" class="btn btn-calypso">
                                more
                            </a>
                        </div>
                    </div>
