<section class="context-dark">
    ...
    <div data-on="false" data-md-on="true" class="rd-parallax">
        <div data-speed="0.25" data-type="media" data-url="{{asset('anl')}}/images/backgrounds/background-09-1920x900.jpg" class="rd-parallax-layer"></div>
            ...
            <div class="shell section-75 section-md-top-103 section-md-bottom-110">
                <div class="range range-xs-center">
                    <div class="cell-sm-10 cell-lg-8">
                        <h2 class="text-spacing-inverse-25 text-capitalize">What Clients Say</h2>
                        <div class="offset-top-35">
                            <!-- Owl Carousel-->
                            <div data-items="1" data-animation-out="slideOutDown" data-animation-in="flipInX" data-stage-padding="5" data-loop="false" data-margin="10" data-mouse-drag="false" data-nav="true" data-dots="true" class="owl-carousel owl-nav-absolute owl-nav-primary owl-nav-primary-type-2">
                                <div class="owl-item">
                                    <!-- Blockquote-->
                                    <blockquote class="quote"><span style="color: rgba(255,255,255,0.3);" class="icon material-icons-ico material-icons-format_quote"></span>
                                        <div class="offset-top-15">
                                            <p class="text-spacing-0">My crew and I greatly enjoyed our Yachtec charter, and we would like to thank you for providing a spectacular boat and an excellent captain on short notice. Your luxury yacht “Othello” was well maintained and equipped. The water maker on board was also a big help.</p>
                                            <div class="offset-top-20">
                                                <cite class="p font-accent text-bold text-spacing-inverce-25"><a href="single-member.html">Richard Nelson</a></cite>
                                                <div class="offset-top-0">
                                                    <p class="font-accent text-bold text-spacing-inverce-25">(client)</p>
                                                </div>
                                            </div>
                                        </div>
                                    </blockquote>
                                ...
                                <div class="owl-item">
                                    ...
                                    <blockquote class="quote"><span style="color: rgba(255,255,255,0.3);" class="icon material-icons-ico material-icons-format_quote"></span>
                                        <div class="offset-top-15">
                                            <p class="text-spacing-0">Our week long Gulet cruise was blessed with perfect weather. I was impressed by the professionalism of Alen and the crew of Gardelin who put the safety and comfort of our group as their priority.</p>
                                            <div class="offset-top-20">
                                                <cite class="p font-accent text-bold text-spacing-inverce-25"><a href="single-member.html">April Smith</a></cite>
                                                <div class="offset-top-0">
                                                    <p class="font-accent text-bold text-spacing-inverce-25">(client)</p>
                                                </div>
                                            </div>
                                ...
                                <div class="owl-item">
                                    ...
                                    <blockquote class="quote"><span style="color: rgba(255,255,255,0.3);" class="icon material-icons-ico material-icons-format_quote"></span>
                                        <div class="offset-top-15">
                                            <p class="text-spacing-0">I can’t believe it’s already been a week since we left the boat. We had a lovely week and good winds and I just wanted to thank you for all your help and information, and answering my endless questions!</p>
                                            <div class="offset-top-20">
                                                <cite class="p font-accent text-bold text-spacing-inverce-25"><a href="single-member.html">John Tompson</a></cite>
                                                <div class="offset-top-0">
                                                    <p class="font-accent text-bold text-spacing-inverce-25">(client)</p>
                                                </div>
                                            </div>
                        ...
                        <div class="btn-both-lines offset-top-20"><a href="testimonials.html" style="min-width:240px;" class="btn btn-calypso">view more testimonials</a></div>
                    </div>
                </div>
            </div>
        </div>
