    ...
    <main class="page-content">
        ...
        <section class="section-75 section-md-top-115 section-md-bottom-95">
            <div class="shell">
                ...
                <div class="max-img range range-xs-center offset-top-15">
        ...
        <section>
            <div class="shell">
                <h5 class="text-spacing-75">{{$photoCategory->name}}</h5>
            </div>
                    ...
                    <div class="owl-item">
                        ...
                        <div class="post-inspiration post-inspiration-img-auto-height">
                            <div class="post-inspiration-img-wrap">
                                <img src="{{asset('storage/'.$photo->image)}}" width="960" height="692" alt="">
                            </div>
