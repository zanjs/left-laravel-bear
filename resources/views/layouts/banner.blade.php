<div data-height="" data-min-height="300px" data-simulate-touch="false" data-slide-effect="fade" class="swiper-container swiper-slider">
    <div class="swiper-wrapper">
        <div data-slide-bg="{{asset('anl/images/backgrounds/background-10-1920x900.jpg')}}" class="swiper-slide"></div>
        <div data-slide-bg="{{asset('anl/images/backgrounds/background-11-1920x900.jpg')}}" class="swiper-slide"></div>
        <div data-slide-bg="{{asset('anl/images/backgrounds/background-12-1920x900.jpg')}}" class="swiper-slide"></div>
    </div>
        ...
        <div class="shell">
            <div class="range range-xs-center">
                <div class="cell-sm-10 cell-lg-8">
                    ...
                    <div class="btns-both-lines group group-sm offset-top-25"><a href="yachts.html" style="min-width:205px;" class="btn btn-primary">sailing yachts</a><a href="charter.html" style="min-width:205px;" class="btn btn-white">yacht charters</a></div>
                </div>
            </div>
        </div>
    </div>
